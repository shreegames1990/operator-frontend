...
import { getImageUrl } from '../packages/shared/api';
...
export function GameCard({ game }: GameCardProps) {
  ...
  return (
    <Link href={gamePath} className="group cursor-pointer block">
      <div className="relative aspect-[3/4] rounded-xl overflow-hidden bg-zinc-200 dark:bg-zinc-800 shadow-md hover:shadow-xl transition-all duration-300 hover:scale-105">
        {imageUrl ? (
          <img
            src={imageUrl}
            alt={game.name}
